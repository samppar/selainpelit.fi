...
// Labyrintti aloittaa valitulta tasolta ja vaikeudelta. Peruspohjan game.js
// luo tilan aina tasolta 1 (E.createState(1, difficulty)); teemme aloitustason
// muuttuvaksi ja annamme pickerin asettaa myös difficultyn (peruspohjan oma muuttuja).
game = game.replace('"use strict";', '"use strict";\n  var selectedLevel = 1;');
const createCalls = game.match(/E\.createState\(1, difficulty\)/g) || [];
if (createCalls.length !== 3) {
  throw new Error("Odotettiin 3 kpl E.createState(1, difficulty) game.js:ssä, löytyi " + createCalls.length);
}
...
<meta name="description" content="Labyrintti — kallista lautaa, vieritä kuula maaliin ja vältä reiät.">
<meta name="theme-color" content="#2a1c12"><title>Labyrintti — selainpelit.fi</title>
...
<section class="board-col" aria-label="Labyrintti-lauta"><div class="brand"><h1>Labyrintti</h1><p>Kallista · vieritä · vältä reiät</p></div>
